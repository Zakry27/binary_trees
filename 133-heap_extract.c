...
/**
 * tree_height - it measures height of binary tree
 * @tree: points to root node of tree to measure height
 *
 * Return: an Height or 0 if tree is NULL
 */
...
/**
 * tree_size_h - it measures sum of heights of binary tree
 * @tree: points to root node of tree to measure height
 *
 * Return: an Height or 0 if tree is NULL
 */
...
/**
 * _preorder - it goes through binary tree using pre-order traversal
...
/**
 * heap_extract - it extracts root node from Max Binary Heap
 * @root: points to heap root
